			...
			<div class="card shadow mb-4">
				...
				<div class="card-body">
					...
					<div class="form-group">
						...
						<a class="btn btn-primary square-btn-adjust btn-sm" href="<?=site_url("patient/visit/" . $patient_id ."/".$appointment_id); ?>"><?php echo $this->lang->line("back_to_visit");?></a>

						<a class="btn btn-primary square-btn-adjust btn-sm" title="<?php echo $this->lang->line("print");?>" target="_blank" href="<?php echo site_url("patient/print_receipt/" . $visit_id); ?>"><?php echo $this->lang->line("print")." ".$this->lang->line("receipt");?></a>

						<a class="btn btn-primary square-btn-adjust btn-sm" title="<?php echo $this->lang->line("payment");?>" href="<?php echo site_url("payment/insert/" . $patient_id . "/bill"); ?>"><?php echo $this->lang->line("bill")." ".$this->lang->line("payment");?></a>

						<?php if (in_array("alert", $active_modules)) {	?>

						<a class="btn btn-primary square-btn-adjust btn-sm" href="<?php echo site_url("patient/email_bill/" . $visit_id."/".$patient_id ); ?>"><?php echo $this->lang->line("email_bill");?></a>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-2">
												...
												<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="particular" /><?php echo $this->lang->line("add");?></button>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												...
												<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="item" /><?php echo $this->lang->line("add");?></button>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												...
												<button class="btn btn-primary  square-btn-adjust btn-sm" type="submit" name="submit" value="fees" /><?php echo $this->lang->line("add");?></button>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												...
												<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="treatment" /><?php echo $this->lang->line("add");?></button>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												...
												<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="lab_test" /><?php echo $this->lang->line("add");?></button>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												...
												<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="discount" /><?php echo $this->lang->line("add");?></button>
									...
									<div class="form-group">
										...
										<div class="col-md-12">
											...
											<div class="col-md-3">
												...
												<button class="btn btn-primary square-btn-adjust btn-sm" type="submit" name="submit" value="tax" /><?php echo $this->lang->line("add");?></button>
